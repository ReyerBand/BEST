...
QCD.close()
H = h5py.File("images/HH_1_BoostedPUPPIphiCosThetaBoostedJetImagesX10.h5","r")
jetImagesDF['H_H'] = H['HH_1_BoostedPUPPI_Higgs_images'][()]
jetImagesDF['H_T'] = H['HH_1_BoostedPUPPI_Top_images'][()]
jetImagesDF['H_W'] = H['HH_1_BoostedPUPPI_W_images'][()]
jetImagesDF['H_Z'] = H['HH_1_BoostedPUPPI_Z_images'][()]
jetBESvarsDF['H'] = H['HH_1_BoostedPUPPI_BES_vars'][()]
H.close()
T = h5py.File("images/TT_1_BoostedPUPPIphiCosThetaBoostedJetImagesX10.h5","r")
jetImagesDF['T_H'] = T['TT_1_BoostedPUPPI_Higgs_images'][()]
jetImagesDF['T_T'] = T['TT_1_BoostedPUPPI_Top_images'][()]
jetImagesDF['T_W'] = T['TT_1_BoostedPUPPI_W_images'][()]
jetImagesDF['T_Z'] = T['TT_1_BoostedPUPPI_Z_images'][()]
jetBESvarsDF['T'] = T['TT_1_BoostedPUPPI_BES_vars'][()]
T.close()
W = h5py.File("images/WW_1_BoostedPUPPIphiCosThetaBoostedJetImagesX10.h5","r")
jetImagesDF['W_H'] = W['WW_1_BoostedPUPPI_Higgs_images'][()]
jetImagesDF['W_T'] = W['WW_1_BoostedPUPPI_Top_images'][()]
jetImagesDF['W_W'] = W['WW_1_BoostedPUPPI_W_images'][()]
jetImagesDF['W_Z'] = W['WW_1_BoostedPUPPI_Z_images'][()]
jetBESvarsDF['W'] = W['WW_1_BoostedPUPPI_BES_vars'][()]
W.close()
Z = h5py.File("images/ZZ_1_BoostedPUPPIphiCosThetaBoostedJetImagesX10.h5","r")
jetImagesDF['Z_H'] = Z['ZZ_1_BoostedPUPPI_Higgs_images'][()]
jetImagesDF['Z_T'] = Z['ZZ_1_BoostedPUPPI_Top_images'][()]
jetImagesDF['Z_W'] = Z['ZZ_1_BoostedPUPPI_W_images'][()]
jetImagesDF['Z_Z'] = Z['ZZ_1_BoostedPUPPI_Z_images'][()]
jetBESvarsDF['Z'] = Z['ZZ_1_BoostedPUPPI_BES_vars'][()]
Z.close()
B = h5py.File("images/BB_1_BoostedPUPPIphiCosThetaBoostedJetImagesX10.h5","r")
jetImagesDF['B_H'] = B['BB_1_BoostedPUPPI_Higgs_images'][()]
jetImagesDF['B_T'] = B['BB_1_BoostedPUPPI_Top_images'][()]
jetImagesDF['B_W'] = B['BB_1_BoostedPUPPI_W_images'][()]
jetImagesDF['B_Z'] = B['BB_1_BoostedPUPPI_Z_images'][()]
jetBESvarsDF['B'] = B['BB_1_BoostedPUPPI_BES_vars'][()]
B.close()
...
for i in range(2, 6):
   for heavy in ('H','T','W','Z','B'):
      ...
      imagefile = h5py.File("images/"+heavy+heavy+"_"+str(i)+"_BoostedPUPPIphiCosThetaBoostedJetImagesX10.h5","r")
      jetImagesDF[heavy+'_H'] = numpy.concatenate([jetImagesDF[heavy+'_H'], imagefile[heavy+heavy+'_'+str(i)+'_BoostedPUPPI_Higgs_images'][()]])
      jetImagesDF[heavy+'_T'] = numpy.concatenate([jetImagesDF[heavy+'_T'], imagefile[heavy+heavy+'_'+str(i)+'_BoostedPUPPI_Top_images'][()]])
      jetImagesDF[heavy+'_W'] = numpy.concatenate([jetImagesDF[heavy+'_W'], imagefile[heavy+heavy+'_'+str(i)+'_BoostedPUPPI_W_images'][()]])
      jetImagesDF[heavy+'_Z'] = numpy.concatenate([jetImagesDF[heavy+'_Z'], imagefile[heavy+heavy+'_'+str(i)+'_BoostedPUPPI_Z_images'][()]])
      jetBESvarsDF[heavy] = numpy.concatenate([jetBESvarsDF[heavy], imagefile[heavy+heavy+'_'+str(i)+'_BoostedPUPPI_BES_vars'][()]])
      imagefile.close()
...
h5f = h5py.File("images/BESTtestDataBESONLY.h5","w")
...
cm = metrics.confusion_matrix(numpy.argmax(model_BEST.predict([testBESvars[:] ]), axis=1), numpy.argmax(testTruth[:], axis=1) )
plt.figure()

targetNames = ['QCD', 'H', 't', 'W', 'Z', 'b']
tools.plot_confusion_matrix(cm.T, targetNames, normalize=True)
if savePDF == True:
   plt.savefig('plots/boost_CosTheta_confusion_matrix_BESONLY.pdf')
if savePNG == True:
   plt.savefig('plots/boost_CosTheta_confusion_matrix_BESONLY.png')
plt.close()
...
joblib.dump(model_BEST, "BEST_keras_CosTheta_BESONLY.pkl")
